...
export default function Home() {
  if (window.innerWidth > 768) {
        ...
        >
          ...
          >
            ...
            <p className="fw-bold">
              ...
              personnes qui ont besoin de mieux connaître une ville. Elle
              fournit des différentes informations sur toutes les villes de la
              planète.
            </p>
            <h4 className="fw-bold">Comment utiliser City Advisor ?</h4>
            <p className="fw-bold">
              Pour utiliser City Advisor, vous devez d'abord créer un compte.
              Une fois connecté, vous pouvez rechercher une ville spécifique et
    ...
    return (
      <>
        <div
          className="col-sm d-flex flex-column align-items-left justify-content-center m-2 p-4 h-100 rounded simple"
          style={{
            minHeight: "70vh",
            backgroundColor: "rgba(255, 255, 255, 0.5)",
          }}
